...
return {
    ...
    VEnabled = "Activer",
    PreventCrash = "Si vous rencontrez des problèmes graphiques ou des crashs, utilisez le bouton Options pour modifier vos paramètres. Pour ouvrir Improved FPS Booster, utilisez",
    FpsCurrent = "Actuel :",
    SelectLangue = "Langue :",
    ...
    CForcedOpen = "Pour ouvrir Improved FPS Booster",
